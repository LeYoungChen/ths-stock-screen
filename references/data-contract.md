...
若要展示进入当前候选池前的历史预筛，提供 `scope.selection_history` 数组，每项如下：

```json
{"label":"MACD预筛","as_of":"2026-09-15","source":"原始名单及查询证据定位",
 "input_codes":["000001.SZ","000002.SZ"],"remaining_codes":["000001.SZ"]}
```
